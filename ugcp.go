...
type GCPAuth struct {
	TokenCache meshauth.TokenCache

	lastAccessToken    string
	lastAccssTokenTime time.Time

	Requests      atomic.Int64
	TokenProvider meshauth.TokenSource
}
...
func (gcp *GCPAuth) GKEClusters(ctx context.Context, token string, p string) ([]*meshauth.Dest, error) {
...
func (gcp *GCPAuth) HubClusters(ctx context.Context, token string, p string) ([]*meshauth.Dest, error) {
...
func (oa *OAuth2Source) Token(ctx context.Context, aud string) (string, error) {
	uv := url.Values{
